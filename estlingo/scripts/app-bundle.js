...
define('contact/contact',["exports"], function (exports) {
    ...
    var about = exports.about = function about() {
        ...
        this.phone = "Phone: +372 123456789";
    };
});
...
define('text!contact/contact.html', ['module'], function(module) { module.exports = "<template><div class=\"body\"><div class=\"main\"><div class=\"content\"><b>${message}</b><br>${email}<br>${phone}</div></div></div></template>"; });
